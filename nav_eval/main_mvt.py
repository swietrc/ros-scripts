...
class NavTest():
    ...
    def __init__(self):
        ...
        locations['depart'] = Pose(Point(2.787, 0.125, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))
        locations['porte'] = Pose(Point(-0.908, 0.234, 0.000), Quaternion(0.000, 0.000, -0.670, 0.743))
        locations['porte_finale'] = Pose(Point(-2.121, -5.865, 0.000), Quaternion(0.000, 0.000, 0.733, 0.680))
        locations['arrivee'] = Pose(Point(1.151, -6.869, 0.000), Quaternion(0.000, 0.000, 0.786, 0.618))
